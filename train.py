...
def parse_arguments():
    ...
    parser.add_argument("--content_dir",type=str, default=r"C:\Users\HP\Desktop\NST\content_data", help="Location of content dataset")
    parser.add_argument("--style_dir",type=str, default=r"C:\Users\HP\Desktop\NST\style_data",help="Location of style dataset")
    parser.add_argument("--vgg",type=str, default=r"C:\Users\HP\Desktop\NST\vgg_normalised.pth", help = "Location of pre-trained VGG")
